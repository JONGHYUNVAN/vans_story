...
export default function PostCard<T extends BasePost>({ 
  ...
  return (
    <article 
      className="group relative rounded-lg bg-[#0f1b2b] text-white hover:shadow-lg hover:shadow-[#2496ed]/30 p-6"
    ...
    >
      <div className="flex items-center justify-between mb-1">
        ...
        <div className="flex items-center gap-3">
          ...
          {renderBadge ? renderBadge(post) : (
            <span className="flex items-center text-xs bg-[#2496ed] text-white px-2 py-1 rounded">
              <SiDocker className="mr-1" /> Docker
            </span>
          )}
        </div>
      </div>
      ...
      <div className="relative h-[1px] my-2 overflow-hidden">
        <div 
          className="absolute inset-0 mx-auto bg-gradient-to-r from-transparent via-[#2496ed] to-transparent"
          style={{
                ...
                <div className="relative w-24 h-24 rounded-md overflow-hidden flex-shrink-0">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      (e.target as HTMLImageElement).src = '/docker-logo.webp';
                    }}
                  />
                </div>
